<p align="center">
  <img src="assets/dossier.svg" alt="Expediente — Ricardo Lopez" width="100%">
</p>
...
<table>
  <tr>
    <td align="center" width="33%">
      <sub>DOMINIO</sub><br><b>PRODUCTO</b><br>
      <sub>5 ERPs en producción</sub><br><sub>NestJS · Prisma · Next.js</sub>
    </td>
    <td align="center" width="33%">
      <sub>DOMINIO</sub><br><b>SEGURIDAD OFENSIVA</b><br>
      <sub>Decepticon · 11 operadores</sub><br><sub>6 operaciones · 5 HTB</sub>
    </td>
    <td align="center" width="33%">
      <sub>DOMINIO</sub><br><b>AGENTES IA</b><br>
...
<table>
  <tr><td width="22%"><sub>RAZONAMIENTO</sub></td><td>Middleware de pentester senior · tech-stack → TTPs · inferencia de cadenas de exploit · pensamiento lateral</td></tr>
  <tr><td><sub>REPORTES</sub></td><td>Markdown → PDF / HTML / DOCX · ejecutivo + técnico · ES / EN</td></tr>
  <tr><td><sub>CONTROL</sub></td><td>Rules of Engagement · gates humanos por fase · SDK · hallazgos SARIF · benchmark interno</td></tr>
</table>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/BLACK--BOX-activo-d4a017?style=flat-square">
  <img src="https://img.shields.io/badge/REPORTES-CVSS_+_PoC-2a2a2a?style=flat-square&labelColor=111">
</p>
